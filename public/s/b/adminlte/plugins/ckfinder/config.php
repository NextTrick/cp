...
// http://docs.cksource.com/ckfinder3-php/configuration.html#configuration_options_backends
 //echo URL_RESOURCES;exit;
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      =>  'http://dev.recargas.coneypark.pe/s/files/contenido/',
    //'root'         => '/home/vagrant/Projects/cp/public/s/files/contenido/', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
