<?php
define('BASE_URL', 'http://localhost/cp/public/');
define('URL_RESOURCES', 'http://localhost/cp/public/');
...
return array(
    ...
    'social' => array(
        'facebook' => array(
            ...
            'redirect_callback' => 'http://localhost/cp/public/login/facebook-callback',
        ),
        'twitter' => array(
            ...
            'redirect_callback' => 'http://localhost/cp/public/login/twitter-callback',
        ),
    )
);