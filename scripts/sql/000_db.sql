...
CREATE TABLE IF NOT EXISTS `usuario_usuario` (
  ...
  `codigo_activar` VARCHAR(100) NULL,
  `historial` TEXT NULL,
  `eliminado_truefi` TINYINT(1) NULL DEFAULT 0 COMMENT '1:eliminado en trueFi\n0: no elminado\n',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `tarjeta_tarjeta` (
  ...
  `emoney` VARCHAR(12) NULL,
  `emoneyvalue` FLOAT NULL,
  `bonus` VARCHAR(12) NULL,
  `bonusvalue` FLOAT NULL,
  `promotionbonus` VARCHAR(12) NULL,
  ...
  `sincronizar` TINYINT(1) NOT NULL DEFAULT 1,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `orden_orden` (
  ...
  `pan` VARCHAR(30) NULL COMMENT 'Personal account number (número de tarjeta de crédito',
  ...
  `estado` VARCHAR(12) NULL COMMENT 'PENDIENTE, PROCESADO',
  `fecha_creacion` DATETIME NULL,
  `fecha_edicion` DATETIME NULL,
  ...
  `moneda` VARCHAR(45) NOT NULL DEFAULT 'PEN' COMMENT 'PEN, USD',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `orden_detalle_orden` (
  ...
  `estado` VARCHAR(12) NULL COMMENT 'NUEVO, PROCESADO, ERROR',
  PRIMARY KEY (`id`),
